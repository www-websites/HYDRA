(() => {
    ...
    function initSliders() {
        if (document.querySelector(".actions__slider")) new core(".actions__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".actions-button_prev",
                nextEl: ".actions-button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".top-category__slider")) new core(".top-category__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".top-category-button_prev",
                nextEl: ".top-category-button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".brands__slider")) new core(".brands__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".brands-button_prev",
                nextEl: ".brands-button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".steps__slider")) new core(".steps__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".steps-button_prev",
                nextEl: ".steps-button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    da.init();
    const stepsNums = document.querySelectorAll(".steps .steps__num");
    let i = 0;
    stepsNums.forEach((element => {
        i++;
        if (i < 10) element.innerHTML = `0${i}`; else element.innerHTML = i;
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
